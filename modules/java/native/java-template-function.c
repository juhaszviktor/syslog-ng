...
#include "java-template-function.h"
...
static void
java_template_function(LogMessage *msg, gint argc, GString *argv[], GString *result)
{

}

TEMPLATE_FUNCTION_SIMPLE(java_template_function);
